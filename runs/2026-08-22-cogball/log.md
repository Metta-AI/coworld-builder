...
2026-08-23T09:27:39Z 60 fix audited: COG_BASE defined at client/replay_broadcast.html (654fea6, static="." via window.CogballStaticReplay, native="<prefix>/client"); second defect found+fixed by predecessor (fb050fb pushFeed built the row it is handed) + GOAL LEAD label (f3f60a7)
2026-08-23T09:27:39Z 60 CI green on main: run 32624523197 sha ed783928319d3405edbaaaf30a5e7926729eaa5e, jobs test/docker-smoke/wasm-viewer all success; new guards viewer_shell_check.cjs (46eedf4) + viewer_smoke.mjs --soak (ed78392) in the wasm-viewer job
2026-08-23T09:27:39Z 60 release dispatch 0.1.4 run=32623293246 SUCCESS ok/canonical/certify true cow_795268b0 — but bundle still froze on tick 2 (pushFeed); superseded
2026-08-23T09:27:39Z 60 release dispatch 0.1.5 run=32624985984 SUCCESS: ok=true canonical=true certify.ok=true replay_liveness=skipped-static secret_put=true; cow_id=cow_ff38b98b-f611-4a74-86e1-f2b23cbd6339 (CHANGED — cow_id is per-version on this platform: 0.1.2/0.1.3/0.1.4/0.1.5 each have their own row); manifest_sha=sha256:495905b1; policies v4 x4, champion2 counter:v4=49bdda05 owned by daveey-1
...
2026-08-23T17:30:00Z post-close: nano-banana art release 0.1.5 -> 0.1.6 (operator, coworld-release.yml dispatch); STATE.coworld.version updated
