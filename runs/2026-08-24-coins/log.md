...
2026-09-03T19:22:23Z 60 check1 TRUE: GET /rounds?league_id=$L&limit=20 -> 20/20 completed (rounds 175-194), 0 failed/discarded, all errors null; fillers a652fffc+9356e1ac still registered (GET /filler-policies 200) and were set 2026-08-25T01:56:08Z, before round 1
2026-09-03T19:22:23Z 60 check2 TRUE: GET /divisions/$D/leaderboard -> daveey-1/coins-ledger:v2 rank3 MMR920.4 rp192 wins192 | daveey/coins-truce:v2 rank4 MMR914.1 rp193 wins155; fillers absent; 5 outside entrants now ranked (richard, relh, Andre von Auto, Andrew Brower, docxology)
2026-09-03T19:22:23Z 60 check3 TRUE: round 194 (round_c2415ebd) -> GET /rounds/$R/episode-requests 21/21 completed (flat ?round_id= now 405); ereq_5af03905 completed, replay_url abaf7183, participants daveey/coins-truce:v2 vs daveey-1/coins-ledger:v2, scores 13-10
2026-09-03T19:22:23Z 60 check4 TRUE: replay abaf7183 36017B strict-JSON ok, protocol coins.replay.v1, results.reason random_end (legal per manifest enum); order sources {"llm":24} — 0 fallbacks (was 41/48 on 2026-08-25); 1 theft + 3 restraint-blocks; trend rounds 191-194 = 110/110 llm, 0 fallback
2026-09-03T19:22:23Z 60 check5 TRUE: hosted log for ereq_5af03905 decoded per playbook §10 (ast.literal_eval) -> CLEAN, zero matches for falling back|LLM provider is unavailable|cut off at max_tokens|rejected; 24/24 sidecar LLM calls HTTP 200, no 429/throttle; both seats registered llm
2026-09-03T19:22:23Z 60 check6 TRUE: raw-HTML iframe grep empty (client-rendered); used SSR state.playlist[0] (featured match coins.r194.e11) + POST /coworlds/replays/session -> static viewer_url .../static/cow_bd320430/sha256%3A6b286bdb.../index.html?v=2#replay=... ready:true; NOT a /client/replay pod URL; note STATE cow_e5c32ad5 (v0.1.2) now 404s — canonical is v0.1.4
2026-09-03T19:22:23Z 60 check7 TRUE: committed runs/2026-08-24-coins/release-result.json .certify.replay_liveness = "Replay liveness: skipped (static replay bundle declared; /client/replay and /replay not required)" (no re-download needed)
2026-09-03T19:22:23Z 60 check8 TRUE: viewer-check.yml run 33795836783 (dispatched 19:20:15Z, green, artifact committed) loaded:true ms:1313 bridge ready; scrub clocks differ 0%="BEAT 1/12 TICK 1 OF 240 · 6 COINS" 50%="BEAT 7/12 TICK 135 OF 240 · 3 COINS" 100%="FINAL 12 BEATS · RANDOM_END"; endcard numbers match results exactly; starter chrome present
2026-09-03T19:22:23Z 60 VERIFY.md written — verdict: all-true (8/8); round 194 / ereq_5af03905; 24/24 llm orders 0 fallback; log CLEAN; viewer-check run 33795836783
